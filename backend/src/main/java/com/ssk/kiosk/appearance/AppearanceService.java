...
public class AppearanceService {
 ...
 public Map<String,Object> defaults(){Map<String,String> headerColors=new LinkedHashMap<>();for(String page:List.of("welcome","gatePass","tasreeh","faceRegistration","accessGranted","language","category","documentCapture","documentReview","visitDetails","review","submitted","pass"))headerColors.put(page,"#ff3158");Map<String,Object> defaults=new LinkedHashMap<>();defaults.put("logoText","DP WORLD");defaults.put("logoUrl","");defaults.put("logoVersion","");defaults.put("logoWidth",116);defaults.put("headerHeight",242);defaults.put("background","#f7f7f8");defaults.put("headerColors",headerColors);defaults.put("contentWidth",540);defaults.put("fontScale",1.0);defaults.put("mobileBreakpoint",768);defaults.put("tabletBreakpoint",1024);defaults.put("pageImages",Map.of());return defaults;}
